...
class Config {
    ...
    public static function get_field_config() {
        return array(
            ...
            'auto_defer_all_css' => array('type' => 'checkbox', 'default' => false, 'description' => 'Automatically defer all CSS files except critical stylesheets. Simplest approach for CSS optimization.'),
            ...
            'smart_youtube_blocking' => array('type' => 'checkbox', 'default' => true, 'description' => 'Defer Elementor YouTube background video loading to prevent render blocking. Videos load after page interactive, eliminating CSP violations and script blocking while keeping video backgrounds.'),
            ...
            'local_font_preloads' => array('type' => 'textarea', 'rows' => 5, 'description' => 'Local font file URLs to preload (one per line). Add .woff2 URLs for self-hosted fonts including Elementor custom fonts. Accepts full URLs or root-relative paths. Example: /wp-content/uploads/elementor/fonts/myfont.woff2'),
