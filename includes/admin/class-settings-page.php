...
class Settings_Page {
    ...
    private function output_hidden_fields($active_tab) {
        $all_fields = array(
            ...
            'images' => array('enable_image_optimization', 'enable_lazy_loading', 'add_width_height_attributes', 'generate_aspect_ratio_css', 'add_decoding_async', 'enable_responsive_image_resizing', 'enable_image_format_conversion', 'avif_quality', 'webp_quality', 'cleanup_orphans_weekly'),
