...
class CoreBoost {
    ...
    public function admin_page() {
        ...
        if (isset($_GET['settings-updated']) && $_GET['settings-updated'] === 'true') {
            ...
            if (isset($_POST['current_tab']) && $_POST['current_tab'] !== $active_tab) {
                echo '<script>
                    if (window.history.replaceState) {
                        var newUrl = window.location.href.replace(/&tab=[^&]*/, "") + "&tab=' . esc_js($_POST['current_tab']) . '";
    ...
    public function ajax_clear_cache() {
        // Verify nonce
        if (!wp_verify_nonce($_POST['nonce'], 'coreboost_clear_cache_nonce')) {
